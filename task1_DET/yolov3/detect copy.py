...
if __name__ == "__main__":
    ...
    for batch_i, (img_paths, input_imgs) in enumerate(dataloader):
        ...
        print('input img size: ',input_imgs.size())
        print(input_imgs[0,0,10:10,10:10])
        # Get detections
        with torch.no_grad():
    ...
    for img_i, (path, detections) in enumerate(zip(imgs, img_detections)):
        ...
        #print(filename)
        pic_savedname = r"output/{}.png".format(filename)
        #pic_savedname = r"output/samples/dog.png"
        plt.savefig(pic_savedname, bbox_inches="tight", pad_inches=0.0)
        plt.close()
